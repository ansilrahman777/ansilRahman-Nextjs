    ...
    <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
      <div className="flex-1 flex flex-col justify-center">
        ...
        <motion.p 
          ...
          I am driven by the belief that technology should be accessible to all,
          and I actively seek opportunities to collaborate, share knowledge, and mentor aspiring developers. 
        </motion.p>
        <motion.div 
          ...
          <div className='flex flex-1 xl:gap-x-6' >
            <div className="relative felx-1 after:w-[1px] after:h-full
        ...
        className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-4">
          {aboutData.map((item,itemIndex)=>{
            return(
              ...
              <div key={(itemIndex)} 
                  className={`${index === itemIndex && 'text-accent after:w-[100%] after:bg-accent after:duration-300'}
